    ...
    <div className='trip-card'>
      <div className='row'>
        ...
        <NavLink to={`/trips/${props.trip.id}`}>
          <div className='col span-3-of-4' onClick={tripShowClickHandler}>{props.trip.name}</div>
        </NavLink>
      </div>
      ...
      <div className='row'>
        ...
        <div className='col span-3-of-4'>{props.trip.trip_lead.first_name}</div>
      </div>
      ...
      <div className='row'>
        ...
        <div className='col span-3-of-4'><p>{props.trip.description}</p></div>
      </div>
      <div className="row">
